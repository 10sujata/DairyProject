     ...
     return(
        ...
        <Form onSubmit= {this.submitData.bind(this)}>
                <FormGroup>
                  ...
                  <Input type="text" id="username" placeholder="Please Enter Your Email" onChange={this.inputUsername}  value={this.state.username} required/>
                ...
                <FormGroup>
                  ...
                  <Input type="select"  value={this.state.userfor} name="select" id="userfor" onChange={this.inputUserfor} required>
                        ...
                        <option value="RMCU">Society application</option>
                      </Input>
