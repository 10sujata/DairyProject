...
class CattleWiseReport extends Component {
  ...
  btnNextClick() {
    ...
    onClick = e => {
      ...
      if(this.state.rmcunnewnumber=="" || this.state.centernamenew=="" ||this.state.farmernumber==""){
        ...
        axios.post(API_BASE_URL+'/cattlewisereport',{
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i> Cattle Wise Report &nbsp;                
  ...
  {/* <Input id="input-search" data={this.state.filteredUsers} onChange={this.handleChange} handleSetData={this.handleSetData} type = "text" placeholder = "Search Engineer" value={this.state.searchInput || ""} name = "search" id = "search"/>&nbsp; */}
              ...
              <FormGroup check inline>
                <Label className="form-check-label" check htmlFor="date">Select Cattle Type</Label>&nbsp;&nbsp;
                <Input type="select" name ="select" id="select" value={this.state.cattletype} onChange={this.CattleType}>
                <option value="1">Please Select Cattle Type</option>
...
export default CattleWiseReport;
