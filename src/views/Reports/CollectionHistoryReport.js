...
class CollectionHistoryReport extends Component {
  ...
  btnNextClick() {
    ...
    onClick = e => {
      e.preventDefault();    
      let errors = {};
      if(this.state.date=="" || this.state.shift==""){
        errors["filtererror"] = "Please select filter";
      }
      else {
        axios.post(API_BASE_URL+'/collectionhistory',{
          datevalue:this.state.date,
          shiftvalue:this.state.shift
          }).then(response => {          
            this.setState({ 
    ...
    render() {
      ...
      let { errors,filteredUsers,currentPage, todosPerPage,upperPageBound,lowerPageBound,isPrevBtnActive,isNextBtnActive } = this.state;
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i> Collection History Report &nbsp;                
  ...
  {/* <Input id="input-search" data={this.state.filteredUsers} onChange={this.handleChange} handleSetData={this.handleSetData} type = "text" placeholder = "Search Engineer" value={this.state.searchInput || ""} name = "search" id = "search"/>&nbsp; */}
              ...
              <FormGroup check inline>
                <Label className="form-check-label" check htmlFor="date">Date</Label>&nbsp;&nbsp;
                <Input className="form-check-input" type="date" id="date" name="date" onChange={this.Date} value={this.state.date}/>
              </FormGroup>
              <FormGroup check inline>
                <Label className="form-check-label" check htmlFor="settingvalue">Select Shift</Label>
                <Input type="select" name ="select" id="select" value={this.state.shift} onChange={this.Shift}>
                  <option value="select">Please Select Shift</option>
...
export default CollectionHistoryReport;
