...
class PendingBillReport extends Component {
  ...
  btnNextClick() {
    ...
    onClick = e => {
      ...
      if(this.state.rmcunnewnumber=="" || this.state.centernamenew=="" ||this.state.farmernumber==""){
        ...
        axios.post(API_BASE_URL+'/pendingbillreport',{
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i> Pending Bill Report &nbsp;                
