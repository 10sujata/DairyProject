...
class ProductSaleReport extends Component {
  ...
  btnNextClick() {
    ...
    onClick = e => {
      e.preventDefault();    
      let errors = {};
      if(this.state.rmcunnewnumber=="" || this.state.centernamenew==""){
        errors["filtererror"] = "Please select filter";
      }
      else {
        axios.post(API_BASE_URL+'/productsalereport',{
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i>  Product Purchase Report &nbsp;                
