...
class ShiftReport extends Component {
  ...
  btnNextClick() {
    ...
    exportCsv(){
      var csvRow = [];
      var newarray = [['S.No.','Farmer No','Farmer Name','Cattle','Weight','FAT','SNF','Rate','Amount']];
      var re = this.state.filteredUsers;
      for(var item=0;item<re.length;item++){
        newarray.push([item,re[item].farmernumber,re[item].farmername,re[item].cattletype,re[item].sum_of_weight,re[item].fat,re[item].snf,re[item].rate,re[item].sum_of_collectionamount]);
      }
