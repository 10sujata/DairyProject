...
class DeductionReport extends Component {
  ...
  btnNextClick() {
    ...
    exportCsv(){
      ...
      a.target = "_Blank";
      a.download = "deductionreport.csv";
    ...
    render() {
      ...
      const renderTodos = currentTodos.map((partners, index) => {
        ...
        <td>
            ...
            <td>{partners.activation_periodfrom}</td>
            <td>{partners.activation_periodto}</td>          
    </tr>;
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i> Deduction Report &nbsp;
