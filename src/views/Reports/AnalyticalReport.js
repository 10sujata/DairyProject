...
class AnalyticalReport extends Component {
   ...
   this.setState({ centerwise: e.target.value });
    ...
    onClick = e => {
      ...
      if(this.state.centerwise==="individual"){
        axios.post(API_BASE_URL+'/analyticalindividualreport',{       
        ...
        axios.post(API_BASE_URL+'/analyticalallreport',{       
          fromdate:this.state.fromdate,
          todate:this.state.todate,
          cattletype:this.state.cattletype,
          shift:this.state.shift,       
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i> Analytical Report &nbsp;
  ...
  {/* <Input id="input-search" data={this.state.filteredUsers} onChange={this.handleChange} handleSetData={this.handleSetData} type = "text" placeholder = "Search Engineer" value={this.state.searchInput || ""} name = "search" id = "search"/>&nbsp; */}
              ...
              <strong><Label className="form-check-label" check htmlFor="fromdate">Analytical Criteria:</Label></strong>&nbsp;&nbsp;
              ...
              <FormGroup check inline>
                    ...
                    <Label className="form-check-label" check htmlFor="criteria">Literwise</Label>
              </FormGroup>
              <FormGroup check inline>
                    ...
                    <Label className="form-check-label" check htmlFor="criteria">Amountwise</Label>
              </FormGroup>
          ...
          <strong><Label className="form-check-label" check htmlFor="centerwise">Centerwise:</Label></strong>&nbsp;&nbsp;
              ...
              <Table responsive bordered>
                  ...
                  <tr>
                    ...
                    <th>Center Code</th>                    
                    <th>Cattle Type</th>                                                                             
                   {this.state.criteria === "fat" && (
                       <th>Avg Fat</th>
                  )} 
                   {this.state.criteria === "snf" && (
                       <th>Avg SNF</th>
                  )} 
                  {this.state.criteria === "lacto" && (
                       <th>Avg Lacto</th>
                  )}
                   {this.state.criteria === "liter" && (
                       <th>Avg Weight</th>
                  )} 
                   {this.state.criteria === "amount" && (
                       <th>Avg Amount</th>
                  )}  
                    <th>Farmer Active/Deactive</th>
