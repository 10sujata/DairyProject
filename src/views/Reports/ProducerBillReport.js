  ...
  btnNextClick() {
    ...
    onClick = e => {
      ...
      if(this.state.rmcunnewnumber=="" || this.state.centernamenew=="" ||this.state.farmernumber==""){
        ...
        axios.post(API_BASE_URL+'/producerbillreport',{
    ...
    render() {
      ...
      const renderTodos = currentTodos.map((partners, index) => {
        ...
        <td>
            {partners.from_date} {partners.to_date}
        </td>
        <td>
            {partners.center_code}
        </td>
        <td>
        ...
        <td>
            {partners.deductionamount}
        </td>
        <td>
            {partners.saletransaction}
        </td>     
        <td>
            {partners.totalbillamount}
        </td>        
    ...
    if(isNextBtnActive === 'disabled') {
     ...
     return(
        ...
        <Card>
              ...
              <CardHeader>
                <i className="fa fa-align-justify"></i> Producer Bill Report &nbsp;                
