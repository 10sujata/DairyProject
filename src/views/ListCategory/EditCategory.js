...
class EditCategory extends Component {
    ...
    componentDidMount() {
        ...
        firebaseConfig
          .database()
          .ref(`/Product Category/`+id)
          .on('value', snap => {
            let allUsers = snap.val();
            console.log("Category data",allUsers);
            this.setState({
                categoryname: allUsers.CategoryName,
                categorydec: allUsers.ProductDescription,
    ...
    submitData(e) {
        const {id} = this.props.match.params;
        const _this = this;
      const { categoryname,categorydec,productname} = this.state;
        e.preventDefault();
          firebaseConfig
          .database()
          .ref(`/Product Category/`+id)
     ...
     return(
        ...
        <Form onSubmit={this.submitData}>
                <FormGroup>
                  ...
                  <Input type="text" id="categoryname" onChange={this.inputCategoryname}  value={this.state.categoryname} />
                </FormGroup>
                <FormGroup>
                ...
                <Button type="submit" size="md" color="danger"><i className="fa fa-dot-circle-o"></i> Update</Button>
