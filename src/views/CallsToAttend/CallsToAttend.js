...
class CallToAttend extends Component {
          ...
          const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("product_category").equalTo(this.state.product_category)
              userref.on("value", snapshot =>{
                ...
                for(let user in allUsers){
                    if(allUsers[user].customer_name==this.state.customername && allUsers[user].status_of_complaint=="empty"){
                      newState.push({
                        id: user,
  ...
  const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
      userref.on("value", snapshot =>{
        ...
        let newState = [];
        for(let user in allUsers){
            if(allUsers[user].status_of_complaint=="empty" && allUsers[user].product_category==this.state.product_category && allUsers[user].customer_name==this.state.customername){
              newState.push({
                id: user,
                Name: allUsers[user].name_of_service_engineer,
                Region: allUsers[user].region_of_service_engineer,
      ...
      const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
          userref.on("value", snapshot =>{
            ...
            let newState = [];
            for(let user in allUsers){
                if(allUsers[user].status_of_complaint=="empty" && allUsers[user].product_category==this.state.product_category){
                  newState.push({
                    id: user,
                    Name: allUsers[user].name_of_service_engineer,
                    Region: allUsers[user].region_of_service_engineer,
      ...
      console.log("dcustomer name",this.state.enddate);
      const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
          userref.on("value", snapshot =>{
            console.log("dsdsds",snapshot.val());
            let allUsers = snapshot.val();
      ...
      const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
          userref.on("value", snapshot =>{
            ...
            let newState = [];
            for(let user in allUsers){
                if(allUsers[user].status_of_complaint=="empty" && allUsers[user].customer_name==this.state.customername){
                  newState.push({
                    id: user,
                    Name: allUsers[user].name_of_service_engineer,
                    Region: allUsers[user].region_of_service_engineer,
  ...
  btnNextClick() {
    ...
    componentDidMount() {
      const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("status_of_complaint").equalTo("empty");
          userref.on("value", snapshot =>{
            let allUsers = snapshot.val();
    ...
    render() {
      ...
      let currentTodos;
       ...
       const renderTodos = currentTodos.map((partners, index) => {
        ...
        <td>
          <span size="md" id="grid" onClick={()=>this.viewcallattend(partners.id)}>
           ...
           <Button className="exportclass" id="export-button" onClick={()=>{this.exportCsv()}}>Export As CSV</Button>&nbsp;
                ...
                <Table responsive bordered>
                  ...
                  <tr>
                      ...
                      <th>View Call To Attend Calls</th>
                      <th>Call Attend</th>                      
                      <th>Delete Call</th>
                  </tr>
                  </thead>
