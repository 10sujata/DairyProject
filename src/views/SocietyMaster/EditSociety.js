...
class EditSociety extends Component {
      ...
      axios.get(API_BASE_URL+'/editsociety/' + id)
       .then(response => {
         ...
         this.setState({
           ...
           rmcuinchargename:response.data.data[0].rmcuinchargename,
           rmcuinchargename1:response.data.data[0].rmcuinchargename1,
    ...
    notify.show('Society Record Created Successfully!','custom', 9000, myColor);
     ...
     return(
        ...
        <Form onSubmit={this.submitData}>
                ...
                <h5> <Label htmlFor="union_name">Dairy Name *</Label> </h5>
                  <Input type="text" id="union_name" placeholder="Union Name" onChange={this.inputUnionValue}  value={this.state.union_name} required/>
                </FormGroup>
            ...
            {this.state.app_image === "http://mcsoft.whitegoldtech.com:8888/rmcuimagefiles/no-image.jpg" ? (
               <h6>No image uploaded</h6>
            ): <img src={`http://mcsoft.whitegoldtech.com:8888/rmcuimagefiles/${this.state.app_image}`} height="200"/>}
