...
class EditSettings extends Component {
    ...
    constructor(props) {
          ...
          .then(response => {
            ...
            if(response.data.data==""){
              ...
              this.setState({
                ...
                checked:response.data.data[0].snfformula,
     ...
     componentDidMount(){
       ...
       axios.get(API_BASE_URL+'/settingslist1')
         ...
         axios.get(API_BASE_URL+'/editsettings/' + id)
          .then(response => {
            ...
            this.setState({
              ...
              rmcuname1:response.data.data[0].rmcuname,
              centername: response.data.data[0].centername,
              scale:response.data.data[0].scale,
              analyzer: response.data.data[0].analyzer,
              analyzer1: response.data.data[0].analyzer,
              cowmorning: response.data.data[0].cowmorning,
              ...
              buffeloevening:response.data.data[0].buffeloevening,
              printingvalue:response.data.data[0].printingvalue,
              printingvalue1:response.data.data[0].printingvalue,
              settingvalue:response.data.data[0].settingvalue,
              headermessage:response.data.data[0].headermessage,
              footermessage:response.data.data[0].footermessage,
              ...
              ratevalue1:response.data.data[0].ratevalue1,
              ratevalue2:response.data.data[0].ratevalue2,
              rmcunameid:response.data.data[0].rmcunameid,
              centernameid:response.data.data[0].centernameid,
              cowmorningname:response.data.data[0].cowmorningname,
              buffelomorningname:response.data.data[0].buffelomorningname,
              coweveningname:response.data.data[0].coweveningname,
              buffeloeveningname:response.data.data[0].buffeloeveningname,
     ...
     submitData(e) {
       ...
       const {id} = this.props.match.params;
        const _this = this;
        const {cowmorningname,buffelomorningname,coweveningname,buffeloeveningname,rmcunameid,centernameid,checked,littervalue,snfvalue,ratevalue1,ratevalue2,headermessage,footermessage,settingvalue,rmcuname,centername,scale,analyzer,cowmorning,buffelomorning,cowevening,buffeloevening,printingvalue,isdeleted} = this.state;
       axios.post(API_BASE_URL+'/updatesettingsform/'+id,{
        cowmorningname,
        buffelomorningname,
        coweveningname,
        buffeloeveningname,
    ...
    render() {
        const {allCenter,snfvalue,allrmcu,centernamenew,ratechart1,ratechart2,ratechart3,ratechart4,printingvalue,printingvalue1,settingvalue} = this.state;
   ...
   return (
     ...
     return(
        ...
        <FormGroup row>
          ...
          <Col md="8">
          {this.state.settingvalue=="common" ? (
            <Input type="text" id="analyzer" onChange={this.analyzer} value={this.state.analyzer1}>
        ...
        <h5><Label htmlFor="footer-message">Options</Label></h5>
          <FormGroup check inline>
            <Input className="form-check-input" type="checkbox" id="printingvalue1" onChange={this.printingvalue1} value="protein" checked={printingvalue1 == "protein"} />
            <Label className="form-check-label" check htmlFor="printingvalue1">Protein</Label>
          </FormGroup>
          <FormGroup check inline>
        ...
        <Button type="button" size="md" color="primary" onClick={()=>this.backbutton()}><i className="fa fa-dot-circle-o"></i> Cancle</Button>
  </Form>
        </Container>
