...
class FarmerMaster extends Component {
    ...
    constructor(props) {
        ...
        this.DCSNO = this.DCSNO.bind(this);
    ...
    handleimagechange(e) {
      ...
      let file_type = e.target.files[0];
       ...
       if(file_type.type === 'image/jpeg' || file_type.type==='image/jpg'||file_type.type==='image/png'){
         errors["imagetypeerror"] = "";
         let maxSizeKB = 25; 
         let maxSize = maxSizeKB * 1024;
         if (file_size > maxSize){
            errors["image1error"] = "Please select small size image";
        ...
        errors["imagetypeerror"] = "Please select valid image";
          this.setState({ errors: errors});
       }
    ...
    componentDidMount() {
      ...
      .then(response => {
        console.log("dairyresponse",response);
          this.setState({
            dairyname:response.data.data[0].union_name,
            //centername: response.data.data[0].center_name,
          });
      ...
      .then(response => {
        ...
        console.log("farmers list",user2);
          this.setState({
          pid1:user2.id,
        });
  ...
  showLoader = () => {
    this.setState({ loading: true });
     ...
     submitData(e){
       ...
       this.showLoader();
         ...
         console.log("sdfss",this.state.cattlevalue);         
      const
      {creationvalue,cattlevalue,rmcunumber,centernumber,rfid,farmername,dob,gender,pid,designation,dairyname,ratechart,dcsno,doj,village,mobilenumber,smsenable,image,uploadvalue1,uploadvalue2,aadharcardnumber,panno,address,village1,taluka,district,state,pincode,country,emailaddress,telno,telno2,education,maritalstatus,hfvalue,jerseyvalue,girvalue,xbreedvalue,localvalue,othervalue,totalcows,murrahvalue,mehsanavalue,jaffarabadivalue,surativalue,localvalue1,othervalue1,totalbuffaloes,cattleshedvalue,milking,bankname,branch,ifscvalue, accountnumber,branchvalue,debitcard,creditcard,isdeleted} = this.state;
       axios.post(API_BASE_URL+'/farmernewform',{
             rfid,
             creationvalue,
             cattlevalue,
             farmername,
    ...
    .catch(error =>{
     ...
     notify.show('Please Fill All The Fields!','custom', 8000, myColor);
     ...
     let myColor = { background: '#1985ac', text: "#FFFFFF", };
    notify.show('Farmer Record Created Successfully!','custom', 20000, myColor);
      }
     ...
     RFID(e) {
      ...
      CreationValue(e){
        console.log("creationvalue",e.target.value);
      ...
      DCSNO(e) {
        this.setState({dcsno: e.target.value});
      ...
      inputRateChart(e) {
        ...
        let id = e.target.value;
        const _this = this;
        console.log("center number",this.state.centernumber);
    ...
    render() {
      ...
      const { cattlevalue,redirect,creationvalue,gender,allrmcu,allUsers,dscnonew,doj,pid1,rmcunumber} = this.state;

    this.state.pid = Number(this.state.pid1)+1;

     console.log("rmcunumber",this.state.pid);
    //console.log("pid id",lastelement);

    if (redirect) {
      return <Redirect to="/listfarmers" />;
    }

        let centerlist = dscnonew.length > 0
    		&& dscnonew.map((item, i) => {
    		return (
            ...
            <Tabs activeKey={this.state.key} onSelect={this.handleSelect}
             id="controlled-tab-example">
                      ...
                      <FormGroup row className="my-0 cshds">
                        <Col xs="12">
                          ...
                          {this.state.creationvalue==="" ?(
                            ...
                            <Input className="form-check-input" type="radio" id="cattlevalue" value="cow" onChange={this.CattleValue}  checked={cattlevalue == "cow"} required/>
                          )}
                          ...
                          <Label className="form-check-label" check htmlFor="cattlevalue">Buffalo</Label>&nbsp;&nbsp;
                            ...
                            {this.state.creationvalue==="" ?(
                              <Input className="form-check-input" type="radio" id="cattlevalue"  value="buffelo" onChange={this.CattleValue}  checked={cattlevalue == "buffelo"} disabled/>
                            ):(
                              <Input className="form-check-input" type="radio" id="cattlevalue"  value="buffelo" onChange={this.CattleValue}  checked={cattlevalue == "buffelo"} required/>
                            )}
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                        <Input type="text" name ="select" id="pid" value={this.state.pid} disable>
                        </Input>
                      </Col>
                    </FormGroup>
                    </Col>
                    ...
                    {this.state.creationvalue === "centercreation" ? (
                        ...
                        <Col md="8">
                        <Input type="select" name ="select" id="select" value={this.state.dcsno} onChange={this.DCSNO}>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                      {this.state.creationvalue==="" ?(
                        <Input type="date" name ="select" id="dojid" defaultValue={date} onChange={this.DOJ} required disabled>
                        </Input>
                      ):(
                        <Input type="date" name ="select" id="dojid" defaultValue={date} onChange={this.DOJ} required>
                        </Input>
                      )}
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                      {this.state.creationvalue==="" ?(
                        <Input type="file" name ="file-input" id="file-input" onChange={this.handleimagechange.bind(this)} required disabled>

                        </Input>
                      ):(
                        <div>
                        <span className="error">{this.state.errors["image1error"]}</span>
                        <span className="error">{this.state.errors["imagetypeerror"]}</span>
                        <Input type="file" name ="file-input" id="file-input" onChange={this.handleimagechange.bind(this)} required accept=".jpeg,.png">
                    ...
                    {this.state.creationvalue==="" ?(
                      <Button align="right" className="firstnextbutton" size="md" color="primary" onClick={()=>this.handleSelect(2)} disabled><i className="fa fa-dot-circle-o tab-button"></i> Next</Button>
                    ):(
                      <Button className="firstnextbutton" align="right" size="md" color="primary" onClick={()=>this.handleSelect(2)}><i className="fa fa-dot-circle-o tab-button"></i> Next</Button>
                    )}
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                        <Input type="text" name ="address" id="addressid" value={this.state.address} onChange={this.Address} required>
                        </Input>
                      </Col>
                    </FormGroup>
                    </Col>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                        <Input type="text" name ="village1" id="village1id" value={this.state.village1} onChange={this.VillageName1} required>
                        </Input>
                      </Col>
                    </FormGroup>
                    </Col>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                        <Input type="text" name ="taluka" id="talukaid" value={this.state.taluka} onChange={this.Taluka} required>
                        </Input>
                      </Col>
                    </FormGroup>
                    </Col>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                         <Input type="text" name ="district" id="districtid" value={this.state.district} onChange={this.District} required>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                         <Input type="text" name ="pincode" id="pincodeid" value={this.state.pincode} onChange={this.Pincode} maxLength="8">
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="telno">Tel No 1</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="hfvalue">HF</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="hfvalue" id="hfvalueid" value={this.state.hfvalue} onChange={this.HFValue} onBlur={this.HFValue1}/>
                      ):(
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                        <Label className="form-check-label" check htmlFor="jerseyvalue">Jersey</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="jerseyvalue" id="jerseyvalueid" value={this.state.jerseyvalue} onChange={this.JerseyValue} onBlur={this.JerseyValue1}>
                        </Input>
                      ):(
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="girvalue">Gir</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="girvalue" id="girvalueid" value={this.state.girvalue} onChange={this.GirValue} onBlur={this.GirValue1}>
                        </Input>
                      ):(
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="xbreedvalue">X Breed</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="xbreedvalue" id="xbreedvalueid" value={this.state.xbreedvalue} onChange={this.XbreedValue} onBlur={this.XbreedValue1}>
                        </Input>
                      ):(
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="localvalue">Local</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="localvalue" id="localvalueid" value={this.state.localvalue} onChange={this.LocalValue} onBlur={this.LocalValue2}>
                        </Input>
                      ):(
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="othervalue" id="othervalueid" value={this.state.othervalue} onChange={this.OtherValue} onBlur={this.OtherValue2}/>
                      ):(
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                      {(this.state.cattlevalue==="cow" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="totalcows" id="totalcowsid" value={this.state.totalcows} onChange={this.TotalCows}>
                        </Input>
                      ):(
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="murrahvalue">Murrah</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="buffelo" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="murrahvalue" id="murrahvalueid" value={this.state.murrahvalue} onChange={this.MurrahValue} onBlur={this.MurrahValue1}>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                      {(this.state.cattlevalue==="buffelo" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="mehsanavalue" id="mehsanavalueid" value={this.state.mehsanavalue} onChange={this.MehsanaValue} onBlur={this.MehsanaValue1}>
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="jaffarabadivalue">Jaffarabdi</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="buffelo" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="jaffarabadivalue" id="jaffarabadivalueid" value={this.state.jaffarabadivalue} onChange={this.Jaffarabadivalue} onBlur={this.Jaffarabadivalue1}>
                    ...
                    <FormGroup row>
                      ...
                      <Col md="8">
                      {(this.state.cattlevalue==="buffelo" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="surativalue" id="surativalueid" value={this.state.surativalue} onChange={this.Surativalue} onBlur={this.Surativalue1}>
                        </Input>
                      ):(
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="localvalue1">Local</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                      {(this.state.cattlevalue==="buffelo" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="localvalue1" id="localvalue1id" value={this.state.localvalue1} onChange={this.LocalValue1} onBlur={this.LocalValue3}>
                    ...
                    <FormGroup row>
                      <Col md="4">
                        <FormGroup check inline>
                          <Label className="form-check-label" htmlFor="othervalue1">Other</Label>
                        </FormGroup>
                      </Col>
                      <Col md="8">
                    ...
                    <FormGroup row>
                      ...
                      {(this.state.cattlevalue==="buffelo" || this.state.cattlevalue==="both") ?(
                        <Input min="0" type="number" name ="totalbuffaloes" id="totalbuffaloesid" value={this.state.totalbuffaloes} onChange={this.TotalBuffaloes}>
...
<Button size="md" color="primary" className="fa fa-dot-circle-o tab-button" onClick={()=>this.handleSelect(2)}>Previous</Button>
            ...
            <FormGroup row>
              <Col md="4">
                <FormGroup check inline>
                  <Label className="form-check-label" htmlFor="bankname">Bank Name</Label>
                </FormGroup>
              </Col>
              <Col md="8">
            ...
            <FormGroup row>
              <Col md="4">
                <FormGroup check inline>
                  <Label className="form-check-label" htmlFor="ifscvalue">IFSC</Label>
                </FormGroup>
              </Col>
              <Col md="8">
            ...
            <FormGroup row>
              <Col md="4">
                <FormGroup check inline>
                  <Label className="form-check-label" htmlFor="accountnumber">A/c number</Label>
                </FormGroup>
              </Col>
              <Col md="8">
                <Input type="text" name ="accountnumber" id="accountnumberid" value={this.state.accountnumber} onChange={this.AccountNumber} onBlur={this.Validateaccount} maxLength="15">
                </Input>
              </Col>
            </FormGroup>
            </Col>
            ...
            <FormGroup row>
              <Col md="4">
                <FormGroup check inline>
                  <Label className="form-check-label" htmlFor="branchvalue">Branch In Village</Label>
                </FormGroup>
              </Col>
              <Col md="8">
            ...
            <FormGroup row>
              <Col md="4">
                <FormGroup check inline>
                  <Label className="form-check-label" htmlFor="file-input">Aadhar Card</Label>
                </FormGroup>
              </Col>
              <Col md="8">
                <Input type="file" name ="file-input" id="file-input" onChange={this.handleimagechange1.bind(this)}>
            ...
            <FormGroup row>
              <Col md="4">
                <FormGroup check inline>
                  <Label className="form-check-label" htmlFor="file-input">Pan Card</Label>
                </FormGroup>
              </Col>
              <Col md="8">
                <Input type="file" name ="file-input" id="file-input" onChange={this.handleimagechange2.bind(this)}>
