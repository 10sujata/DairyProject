 ...
 accountnumber,branchvalue,debitcard,creditcard,isdeleted} = this.state;
    ...
    notify.show('Data Updated Successfully!','custom', 15000, myColor);
      ...
      RFID(e) {
       ...
       FarmerName(e) {
         console.log("fdfdfds",e.target.value);
    ...
    render() {
      ...
      const {creationvalue, dscnonew,cattlevalue, redirect ,gender,allrmcu,allCenter} = this.state;
           ...
           <Tabs activeKey={this.state.key} onSelect={this.handleSelect}
            id="controlled-tab-example">
                <Tab eventKey={1} title="Farmer Details">
                   ...
                   <Col md="8">
                   <FormGroup check inline>
                   <Label className="form-check-label" check htmlFor="creationvalue">RMCU Farmer Creation</Label>&nbsp;&nbsp;
