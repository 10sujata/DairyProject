...
class ListUsers extends Component {
      ...
      globalSearch = () => {
        ...
        let filteredData = this.state.allUsers.filter(value => {
          ...
          return (
            ...
            value.user_for.toLowerCase().includes(searchInput.toLowerCase())                     
          );
        });
  ...
  <Input id="input-search" data={this.state.filteredUsers} onChange={this.handleChange} handleSetData={this.handleSetData} type = "text" placeholder = "Search Users" value={this.state.searchInput || ""} name = "search" id = "search"/>&nbsp;
              </CardHeader>
              <CardBody>
