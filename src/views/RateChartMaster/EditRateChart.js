...
class EditRateChart extends Component {
    ...
    constructor(props) {
      ...
      SomeDeleteRowFunction(event,item) {
        var array = [...this.state.conditionsarray];
        var index = array.indexOf(item);
         array.splice(index, 1);
         console.log("fdsfsdfsdf",array);
         this.setState({conditionsarray: array});
     }
...
console.log("sorted array",ratechartmatrixvalue);
        ...
        var elements = this.state.conditionsarray.slice();
        ...
        this.setState({ conditionsarray: elements, ratechartmatrixvalue: "", increvalue: "",matrixfatrangefrom:"",matrixfatrangeto:"",condition:"" });
      }
      ...
      componentDidMount() {
        ...
        .then(json => {
          if(json.data.message==="Successfully"){
            this.setState({
                chartname: json.data.data[0].chartname,
                chartname1:json.data.data[0].chartname1,
                effectivedate:json.data.data[0].effective_date,
                expirydate: json.data.data[0].expiration_date,
                shift: json.data.data[0].shift,
                ratechart:json.data.data[0].ratechart,
                charttype:json.data.data[0].charttype,
                cattletype:json.data.data[0].cattletype,
                fatrange_from:json.data.data[0].fatrange_from,
                fatrange_to:json.data.data[0].fatrange_to,
                fatsnfrange_from:json.data.data[0].fatsnfrange_from,
                fatsnfrange_to:json.data.data[0].fatsnfrange_to,
                fixedrate:json.data.data[0].fixedrate,
                fatvalue:json.data.data[0].fat_value,
                snfvalue:json.data.data[0].snf_value,
                submitvalue:"disable"
              });
          }
          else {
            ...
            console.log("response matrix",(json.data.data));
        ...
        axios.get(API_BASE_URL+'/listconditions/'+ id)
        .then(response => {
            this.setState(
            {
              conditionsarray: JSON.parse(response.data.data[0].rate_field),
              //conditionsarraynew: response.data.data[0].rate_field
            }
          );
            //console.log("response matrix one",response.data.data[0].rate_field);
    ...
    render() {
      const { open } = this.state;
     const {cattletype,conditionsarray} = this.state;
     const {isSubmitted} = this.state;
      const { redirect,allUsers,items } = this.state;
        if (redirect) {
          return <Redirect to="/ratechartmaster" />;
        }
        //console.log("conditions array",JSON.parse(conditionsarray) );
    ...
    let currentTodos;
     ...
     const conditionlist = conditionsarray.map((item,index)=>{
        return <tr key={index}>
        <td>{item.ratechartmatrixvalue}</td>
        <td>{item.increvalue}</td>
        <td>{item.matrixfatrangefrom}</td>
        <td>{item.matrixfatrangeto}</td>
        <td>{item.condition}</td>
        <td><Button onClick={(event) => this.SomeDeleteRowFunction(event, index,item)} disabled={this.state.submitvalue}>Delete</Button></td>
        </tr>
     });
     ...
     return(
        ...
        <Container>
          ...
          <FormGroup>
            ...
            <Input type="text" id="chartname" readOnly={this.state.submitvalue} onChange={this.ChartName} value={this.state.chartname}/>
          </FormGroup>
          </Col>
          <Col xs="6">
          <FormGroup>
            <h5><Label htmlFor="chartname1">Rate Chart Name In Regional Language *</Label></h5>
            <Input type="text" id="chartname1" readOnly={this.state.submitvalue} onChange={this.ChartName1} value={this.state.chartname}/>
          </FormGroup>
          </Col>
          </FormGroup>
          <FormGroup row className="my-0">
          ...
          <FormGroup row>
            ...
            <Col md="8">
            <Input type="date" id="effectivedate" readOnly={this.state.submitvalue} onChange={this.EffectiveDate} value={this.state.effectivedate} />
          ...
          <FormGroup row>
            ...
            <Col md="8">
            <Input type="date" id="expirydate" readOnly={this.state.submitvalue} onChange={this.ExpiryDate} value={this.state.expirydate} max={moment().format("2021-03-31")}/>
            </Col>
          </FormGroup>
          </Col>
          </FormGroup>
          ...
          <CardBody>
                ...
                <FormGroup>
                  ...
                  <Input type="select" readOnly={this.state.submitvalue} value={this.state.shift} name="select" id="shift" onChange={this.Shift}>
                        <option value="0" readOnly={this.state.submitvalue}>Please Select</option>
                ...
                <FormGroup>
                  ...
                  <Input type="select" readOnly={this.state.submitvalue} value={this.state.ratechart} name="select" id="ratechart" onChange={this.RateChart}>
              ...
              <FormGroup>
                ...
                <Input type="select" readOnly={this.state.submitvalue} value={this.state.charttype} name="select" id="charttype" onChange={this.ChartType}>
                      <option value="no-chart">Please Select</option>
                      <option value="fat-chart">FAT</option>
                      <option value="fatsnf-chart">FAT-SNF</option>
                      <option value="fat-lacto">FAT-LACTO</option>
                </Input>
              </FormGroup>
              </Col>
              <Col xs="6">
              ...
              <FormGroup row>
                <Col md="9">
                  <FormGroup check inline>
                    <Input className="form-check-input" readOnly={this.state.submitvalue} type="radio" id="cattletype" name="cattletype" onChange={this.CattleType} value="cow" checked={cattletype == "cow"}  />
                    <Label className="form-check-label" check htmlFor="cattletype">Cow</Label>
                  </FormGroup>
                  <FormGroup check inline>
                    <Input className="form-check-input" readOnly={this.state.submitvalue} type="radio" id="cattletype" name="cattletype" onChange={this.CattleType}  value="buffalo" checked={cattletype=="buffalo"}/>
          ...
          <Col xs="12">
            ...
            {this.state.charttype === "fat-chart" && (
              ...
              <FormGroup>
                ...
                <Input type="text" id="fatrange_from" readOnly={this.state.submitvalue} onChange={this.FatRange_From} value={this.state.fatrange_from}/>
              </FormGroup>
              </Col>
              <Col md="6">
              <FormGroup>
                <h7><Label htmlFor="fatrange_to">FAT Range To *</Label></h7>
                <Input type="text" id="fatrange_to" readOnly={this.state.submitvalue} onChange={this.FatRange_To} value={this.state.fatrange_to}/>
              </FormGroup>
              </Col>
              </FormGroup>
            ...
            {this.state.charttype === "fatsnf-chart" && (
              ...
              <FormGroup>
                <h7><Label htmlFor="fatrange_from">FAT Range From *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue}  id="fatrange_from" placeholder="Please Enter Fat Range" onChange={this.FatRange_From} value={this.state.fatrange_from}/>
              </FormGroup>
              </Col>
              <Col md="3">
              <FormGroup>
                <h7><Label htmlFor="fatrange_to">FAT Range To *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue} id="fatrange_to" placeholder="Please Enter Fat Range" onChange={this.FatRange_To} value={this.state.fatrange_to}/>
              </FormGroup>
              </Col>
              <Col md="3">
              <FormGroup>
                <h7><Label htmlFor="fatsnfrange_from">SNF Range From *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue} id="fatsnfrange_from" onChange={this.FatSnfRange_From} value={this.state.fatsnfrange_from}/>
              </FormGroup>
              </Col>
              <Col md="3">
              <FormGroup>
                <h7><Label htmlFor="fatsnfrange_to">SNF Range To *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue} id="fatsnfrange_to" onChange={this.FatSnfRange_To} value={this.state.fatsnfrange_to}/>
              </FormGroup>
              </Col>
              </FormGroup>
            ...
            {this.state.charttype === "fat-lacto" && (
              ...
              <FormGroup>
                <h7><Label htmlFor="fatrange_from">FAT Range From *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue} id="fatrange_from" placeholder="Please Enter Fat SNF Range" onChange={this.FatRange_From} value={this.state.fatrange_from}/>
              </FormGroup>
              </Col>
              <Col md="3">
              <FormGroup>
                <h7><Label htmlFor="fatrange_to">FAT Range To *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue} id="fatrange_to" placeholder="Please Enter Fat SNF  Range" onChange={this.FatRange_To} value={this.state.fatrange_to}/>
              </FormGroup>
              </Col>
              <Col md="3">
              <FormGroup>
                <h7><Label htmlFor="fatsnfrange_from">Lacto Range From *</Label></h7>
                <Input type="text" readOnly={this.state.submitvalue} id="fatsnfrange_from" placeholder="Please Enter Fat Range" onChange={this.FatSnfRange_From} value={this.state.fatsnfrange_from}/>
              </FormGroup>
              </Col>
              <Col md="3">
              <FormGroup>
                <h7><Label htmlFor="fatsnfrange_to">Lacto Range To *</Label></h7>
                <Input type="text"readOnly={this.state.submitvalue}  id="fatsnfrange_to" placeholder="Please Enter Fat Range" onChange={this.FatSnfRange_To} value={this.state.fatsnfrange_to}/>
              </FormGroup>
              </Col>
              </FormGroup>
          ...
          <FormGroup row className="my-0">
            ...
            {this.state.charttype === "fat-chart" && (
              <FormGroup row>
               ...
               <Col md="5">
               <FormGroup>
                <Input type="text" readOnly={this.state.submitvalue} id="fixedrate" onChange={this.FixedRate} value={this.state.fixedrate}/>
                </FormGroup>
               </Col>
               <Col md="1">
               <FormGroup>
                ...
                <Col md="5">
                 <FormGroup>
                 <Input type="text" readOnly={this.state.submitvalue} id="fatvalue" onChange={this.FatValue} value={this.state.fatvalue}/>
                 </FormGroup>
                </Col>
              </FormGroup>
            )}
            {this.state.charttype === "fatsnf-chart" && (
              <FormGroup row>
               ...
               <Col md="3">
               <FormGroup>
                 <Input type="text" readOnly={this.state.submitvalue} id="snfvalue"  onChange={this.SNFValue} value={this.state.snfvalue}/>
               </FormGroup>
               </Col>
              </FormGroup>
            )}
            ...
            {this.state.charttype === "fat-lacto" && (
              <FormGroup row>
               ...
               <Col md="3">
               <FormGroup>
                 <Input type="text" readOnly={this.state.submitvalue} id="fatvalue" onChange={this.SNFValue} value={this.state.snfvalue}/>
               </FormGroup>
               </Col>
               <Col md="1">
               <FormGroup>
               ...
               <Col md="3">
               <FormGroup>
                 <Input type="text" readOnly={this.state.submitvalue} id="lactovalue"  onChange={this.LactoValue} value={this.state.lactovalue}/>
               </FormGroup>
               </Col>
              </FormGroup>
            )}
          ...
          <FormGroup>
            ...
            <Input type="select" name="ratechartmatrixvalue" id="ratechartmatrixvalue" value={this.state.ratechartmatrixvalue} onChange={this.changeHandler} readOnly={this.state.submitvalue}>
                  <option value="0">Please Select</option>
          ...
          <FormGroup>
            ...
            <Input type="select" name="increvalue" id="increvalue" value={this.state.increvalue} onChange={this.changeHandler} readOnly={this.state.submitvalue}>
                  <option value="0">Please Select</option>
          ...
          <FormGroup>
            ...
            <Input type="text" id="matrixfatrangefrom" placeholder="Please Enter Fat Range From" name="matrixfatrangefrom" value={this.state.matrixfatrangefrom} onChange={this.changeHandler} onBlur={this.handleBlur} readOnly={this.state.submitvalue}/>
          ...
          <FormGroup>
            ...
            <Input type="text" id="matrixfatrangeto" placeholder="Please Enter Fat Range To" name="matrixfatrangeto" value={this.state.matrixfatrangeto} onChange={this.changeHandler} onBlur={this.handleBlur1} readOnly={this.state.submitvalue}/>
          ...
          <FormGroup>
            ...
            <Input type="text" id="condition" placeholder="Please Enter Condition" name="condition" value={this.state.condition} onChange={this.changeHandler} readOnly={this.state.submitvalue}/>
          </FormGroup>
          </Col>
          </FormGroup>
          </FormGroup>
          <FormGroup>
              ...
              <Button type="button" size="md" color="primary" onClick={() => this.AddElementsOnSubmit()}><i className="fa fa-dot-circle-o"></i> Add Condition</Button>
                  ...
                  <Table responsive bordered readOnly={this.state.submitvalue}>
                    <thead>
                  ...
                  <Button type="submit" disabled={this.state.submitvalue} size="md" color="primary"><i className="fa fa-dot-circle-o"></i> Submit</Button>&nbsp;&nbsp;
