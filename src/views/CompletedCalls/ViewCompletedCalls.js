...
class ViewCompletedCalls extends Component {
    constructor(props) {
        super(props);
        this.state = {
      ...
      componentDidMount() {
          ...
          userref.on("value", snapshot => {
              ...
              this.setState({
                  ...
                  servicecharge1:allUsers.servicecharge1,
                  servicecharge:allUsers.servicecharge,
                  expensecharge1:allUsers.expensecharge1,
                  foc1:allUsers.foc1,
                  modeofpayment:allUsers.modeofpayment
...
export default ViewCompletedCalls;
