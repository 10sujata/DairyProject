...
class CompletedCall extends Component {
    ...
    constructor(props) {
         ...
         if(this.state.customername!="" && this.state.product_category!=""){
               const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("product_category").equalTo(this.state.product_category)
                   userref.on("value", snapshot =>{
                     ...
                     for(let user in allUsers){
                         if(allUsers[user].user_uid==isLoggedIn && allUsers[user].customer_name==this.state.customername && allUsers[user].status_of_complaint=="Completed"){
                           newState.push({
                             id: user,
           ...
           const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("customer_name").equalTo(this.state.customername)
               userref.on("value", snapshot =>{
                 ...
                 let newState = [];
                 for(let user in allUsers){
                     if(allUsers[user].user_uid==isLoggedIn && allUsers[user].status_of_complaint=="Completed"){
                       newState.push({
                         id: user,
                         Name: allUsers[user].name_of_service_engineer,
                         Region: allUsers[user].region_of_service_engineer,
      ...
      const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
          userref.on("value", snapshot =>{
            ...
            let newState = [];
            for(let user in allUsers){
                if(allUsers[user].user_uid==isLoggedIn && allUsers[user].status_of_complaint=="Completed" && allUsers[user].product_category==this.state.product_category && allUsers[user].customer_name==this.state.customername){
                  newState.push({
                    id: user,
                    Name: allUsers[user].name_of_service_engineer,
                    Region: allUsers[user].region_of_service_engineer,
        ...
        const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
            userref.on("value", snapshot =>{
              ...
              let newState = [];
              for(let user in allUsers){
                  if(allUsers[user].user_uid==isLoggedIn && allUsers[user].status_of_complaint=="Completed" && allUsers[user].product_category===this.state.product_category){
                    newState.push({
                      id: user,
                      Name: allUsers[user].name_of_service_engineer,
                      Region: allUsers[user].region_of_service_engineer,
    ...
    const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(this.state.enddate)
        userref.on("value", snapshot =>{
          ...
          let newState = [];
          for(let user in allUsers){
              if(allUsers[user].user_uid==isLoggedIn && allUsers[user].status_of_complaint=="Completed" && allUsers[user].customer_name==this.state.customername){
                newState.push({
                  id: user,
                  Name: allUsers[user].name_of_service_engineer,
                  Region: allUsers[user].region_of_service_engineer,
