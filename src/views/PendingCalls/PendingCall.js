...
class PendingCall extends Component {
    ...
    constructor(props) {
      ...
      onOpenModal = () => {
         ...
         if(this.state.customername!="" && this.state.product_category!=""){
               const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("product_category").equalTo(this.state.product_category)
                   userref.on("value", snapshot =>{
                     ...
                     for(let user in allUsers){
                         if(allUsers[user].user_uid==isLoggedIn && allUsers[user].customer_name==this.state.customername && (allUsers[user].status_of_complaint==="Other"||allUsers[user].status_of_complaint==="Spare part Required"||allUsers[user].status_of_complaint==="System sent to factory for repair"||allUsers[user].status_of_complaint==="Needs to be visited again"||allUsers[user].status_of_complaint==="Under-Repaired" || allUsers[user].status_of_complaint==="Other")){
                           newState.push({
                             id: user,
           ...
           const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("customer_name").equalTo(this.state.customername)
               userref.on("value", snapshot =>{
                 ...
                 let newState = [];
                 for(let user in allUsers){
                     if(allUsers[user].user_uid==isLoggedIn && (allUsers[user].status_of_complaint==="Other"||allUsers[user].status_of_complaint==="Spare part Required"||allUsers[user].status_of_complaint==="System sent to factory for repair"||allUsers[user].status_of_complaint==="Needs to be visited again"||allUsers[user].status_of_complaint==="Under-Repaired" || allUsers[user].status_of_complaint==="Other")){
                       newState.push({
                         id: user,
                         Name: allUsers[user].name_of_service_engineer,
                         Region: allUsers[user].region_of_service_engineer,
          ...
          const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("product_category").equalTo(this.state.product_category)
              userref.on("value", snapshot =>{
                ...
                let newState = [];
                for(let user in allUsers){
                    if(allUsers[user].user_uid==isLoggedIn && (allUsers[user].status_of_complaint==="Other"||allUsers[user].status_of_complaint==="Spare part Required"||allUsers[user].status_of_complaint==="System sent to factory for repair"||allUsers[user].status_of_complaint==="Needs to be visited again"||allUsers[user].status_of_complaint==="Under-Repaired")){
                      newState.push({
                        id: user,
                        Name: allUsers[user].name_of_service_engineer,
                        Region: allUsers[user].region_of_service_engineer,
        ...
        const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(date)
            userref.on("value", snapshot =>{
              console.log("dsdsds",snapshot.val());
              let allUsers = snapshot.val();
              let newState = [];
...
if((allUsers[user].status_of_complaint==="Other"||allUsers[user].status_of_complaint==="Spare part Required"||allUsers[user].status_of_complaint==="System sent to factory for repair"||allUsers[user].status_of_complaint==="Needs to be visited again"||allUsers[user].status_of_complaint==="Under-Repaired") && allUsers[user].product_category==this.state.product_category && allUsers[user].customer_name==this.state.customername && allUsers[user].user_uid==isLoggedIn){
        ...
        const userref =  firebaseConfig.database().ref(`/Calls/`).orderByChild("call_log_date").startAt(this.state.startdate).endAt(date)
            userref.on("value", snapshot =>{
              ...
              let newState = [];
              for(let user in allUsers){
                  if((allUsers[user].status_of_complaint==="Other"||allUsers[user].status_of_complaint==="Spare part Required"||allUsers[user].status_of_complaint==="System sent to factory for repair"||allUsers[user].status_of_complaint==="Needs to be visited again"||allUsers[user].status_of_complaint==="Under-Repaired") && allUsers[user].product_category==this.state.product_category && allUsers[user].user_uid==isLoggedIn){
                    newState.push({
                      id: user,
                      Name: allUsers[user].name_of_service_engineer,
                      Region: allUsers[user].region_of_service_engineer,
        ...
        <Card>
          ...
          <Input className="searchclass" id="input-search" data={this.state.callsAttend} onChange={this.handleChange} handleSetData={this.handleSetData} type = "text" placeholder = "Search Engineer" value={this.state.searchInput || ""} name = "search" id = "search"/><br />
              ...
              <div className="headernewclass">
                ...
                <Input type="date" className="endclass" id="enddate" value={date} />
                </div>
